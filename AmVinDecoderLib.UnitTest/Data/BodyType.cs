...
namespace AmVinDecoderLib.UnitTest.Data
{
    ...
    public class BodyType
    {
        ...
        public void Lookup_02_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Convertible", 2, BodyStyle.Convertible);
        }
        ...
        public void Lookup_05_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "DBS", 2, BodyStyle.Coupe);
        }
        ...
        public void Lookup_AA_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "DB9 Coupe", 2, BodyStyle.Coupe);
        }
        ...
        public void Lookup_AB_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "DB9 Convertible", 2, BodyStyle.Convertible);
        }
        ...
        public void Lookup_BB_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Vantage roadster", 2, BodyStyle.Convertible);
        }
        ...
        public void Lookup_BE_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Vantage S convertible", 2, BodyStyle.Convertible);
        }
        ...
        public void Lookup_BF_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "V12 Vantage/S convertible", 2, BodyStyle.Convertible);
        }
        ...
        public void Lookup_BP_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "V12VS w/ sports+ pack convertible", 2, BodyStyle.Convertible);
        }
        ...
        public void Lookup_CA_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "DBS Coupe", 2, BodyStyle.Coupe);
        }
        ...
        public void Lookup_CC_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "DBS convertible", 2, BodyStyle.Convertible);
        }
        ...
        public void Lookup_CE_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Vanquish coupe", 2, BodyStyle.Coupe);
        }
        ...
        public void Lookup_CG_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Vanquish convertible", 2, BodyStyle.Convertible);
        }
        ...
        public void Lookup_CJ_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Vanquish S coupe", 2, BodyStyle.Coupe);
        }
        ...
        public void Lookup_CL_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Vanquish S convertible", 2, BodyStyle.Convertible);
        }
        ...
        public void Lookup_CP_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Vanquish Zagato coupe", 2, BodyStyle.Coupe);
        }
        ...
        public void Lookup_CR_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Vanquish Zagato convertible", 2, BodyStyle.Convertible);
        }
        ...
        public void Lookup_DA_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Rapide", 4, BodyStyle.Sedan);
        }
        ...
        public void Lookup_DE_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Rapide S", 4, BodyStyle.Sedan);
        }
        ...
        public void Lookup_DF_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Rapide Shadow Ed", 4, BodyStyle.Sedan);
        }
        ...
        public void Lookup_EA_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Virage coupe", 2, BodyStyle.Coupe);
        }
        ...
        public void Lookup_EB_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Virage convertible", 2, BodyStyle.Convertible);
        }
        ...
        public void Lookup_FA_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "DB11 coupe", 2, BodyStyle.Coupe);
        }
        ...
        public void Lookup_FC_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "DB11 convertible", 2, BodyStyle.Convertible);
        }
