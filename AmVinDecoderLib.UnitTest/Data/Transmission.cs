...
namespace AmVinDecoderLib.UnitTest.Data
{
    ...
    public class Transmission
    {
        ...
        public void Lookup_A_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Manual", TransmissionType.Manual, 6);
        }
        ...
        public void Lookup_C_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Auto", TransmissionType.Automatic, 6);
        }
        ...
        public void Lookup_E_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Sportshift", TransmissionType.AutomatedManual, 6);
        }
        ...
        public void Lookup_G_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Toyota Manual", TransmissionType.Manual, 6);
        }
        ...
        public void Lookup_JIsNotV12VantageS_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Sportshift II", TransmissionType.AutomatedManual, 7);
        }
        ...
        public void Lookup_JIsV12VantageS_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "Sportshift III", TransmissionType.AutomatedManual, 7);
        }
        ...
        public void Lookup_L_ReturnsExpectedValues()
        {
            ...
            TestValues(result, "8-speed Auto", TransmissionType.Automatic, 8);
        }
        ...
        private void TestValues(vin.Transmission actual, string expectedText, TransmissionType expectedTransmissionType, int expectedForwardSpeeds)
        {
